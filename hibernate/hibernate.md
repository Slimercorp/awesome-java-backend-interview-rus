...
## Как включить кэш второго уровня?
...
+ Использовать аннотацию `@Cache` и указание настройки стратегии кэширование над entity bean (т.е. нужно указать самому хибернейту, что именно кешировать)
```java
